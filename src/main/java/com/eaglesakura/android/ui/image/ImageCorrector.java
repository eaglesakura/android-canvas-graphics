...
public class ImageCorrector {
    ...
    public void moveToTargetLeft(float targetX, float move) {
        float oldValue = imageArea.left;
        imageArea.left = MathUtil.targetMove(imageArea.left, move, targetX);
        float offsetValue = imageArea.left - oldValue;
        imageArea.right += offsetValue;
    }

    public void moveToTargetRight(float targetX, float move) {
        float oldValue = imageArea.right;
        imageArea.right = MathUtil.targetMove(imageArea.right, move, targetX);
        float offsetValue = imageArea.right - oldValue;
        imageArea.left += offsetValue;
    }

    public void moveToTargetBottom(float targetX, float move) {
        float oldValue = imageArea.bottom;
        imageArea.bottom = MathUtil.targetMove(imageArea.bottom, move, targetX);
        float offsetValue = imageArea.bottom - oldValue;
